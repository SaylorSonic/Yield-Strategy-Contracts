...
contract Bills is ERC20Burnable, Operator {
    ...
    // Additional initial distribution for LPs & pools
    uint256 public constant INITIAL_BILL_POOL_DISTRIBUTION = 0 ether;

    // Have the rewards been distributed to the pools
    bool public rewardPoolDistributed = false;

    /**
     * @notice Constructs the BILL ERC-20 contract.
     */
    constructor() ERC20("Yield Strategy Bills", "BILLS") {
        // Mints 1 BILL to contract creator for initial pool setup
        _mint(msg.sender, 1 ether);   
    }

    /**
     * @notice Operator mints BILL to a recipient
     * @param recipient_ The address of recipient
     * @param amount_ The amount of BILL to mint to
    ...
    function distributeReward(
        ...
        require(_billPool != address(0), "!_billPool");
        rewardPoolDistributed = true;
        _mint(_genesisPool, INITIAL_GENESIS_POOL_DISTRIBUTION);
        _mint(_billPool, INITIAL_BILL_POOL_DISTRIBUTION);
    }
